/*
  ...
  - Added the required column `medication_amount` to the `shipment_loads` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_shipment_loads" ("id", "medication_id", "shipment_id") SELECT "id", "medication_id", "shipment_id" FROM "shipment_loads";
